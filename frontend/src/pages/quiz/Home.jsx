...
function Home() {
  ...
  const handleDelete = async (quiz) => {
    const ok = window.confirm(`Xoa bai test "${quiz.title}"? Hành động này không thể hoàn tác!`);
    if (!ok) return;
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-5 md:px-12 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center text-xl text-gray-600">Chưa có bài test nào</div>
        ) : (
