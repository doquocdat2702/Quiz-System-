  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        ...
        toast.error("Loi khi tai lich su");
        console.error(error);
      } finally {
        setLoading(false);
      }
      ...
      <main className="px-5 md:px-12 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 rounded-2xl bg-white border border-gray-200 p-6 shadow-sm">
            <h1 className="text-3xl md:text-5xl font-black text-gray-950">Lich su lam bai</h1>
            <p className="text-gray-500 mt-3">Xem lai diem va chi tiet cac lan lam bai cua ban.</p>
          </div>
