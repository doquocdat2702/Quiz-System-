...
function JoinQuizPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!cleanCode) {
      toast.error("Vui long nhap ma bai test");
      return;
    }
    ...
    try {
      ...
      toast.error(error.message || "Khong tim thay bai test");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="px-5 py-12">
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-lg">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-gray-950 mb-3">Nhap ma bai test</h1>
          <p className="text-gray-500 mb-6">
            Nguoi tao bai se chia se cho ban mot ma ngan. Nhap ma do de bat dau lam bai.
          </p>
